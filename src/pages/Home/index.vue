	...
	<div class="home">
		<el-container>
			<el-aside width="200px">
				<h1 class="logo"></h1>
				<el-menu default-active="1" class="el-menu-vertical-demo" :collapse="isCollapse" text-color="#4e5bf8" :router="true"
				 active-text-color="rgb(228, 120, 51)">
					...
					<el-submenu index="2">
						...
						<el-menu-item-group>
							<el-menu-item index="studentProduct"><i class="iconfont icon-wode1"></i>学员项目管理</el-menu-item>
							<el-menu-item index="studentProfile"><i class="iconfont icon-kaoqin2"></i>学员资料</el-menu-item>
							<el-menu-item index="studentDormitory"><i class="iconfont icon-shuju2"></i>学员宿舍</el-menu-item>
						</el-menu-item-group>
					</el-submenu>
